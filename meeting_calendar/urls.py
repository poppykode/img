...
urlpatterns = [
    ...
    path('a/availability-and-session-expectation/', views.availability_and_session_expectation, name='availability_and_session_expectation'),
    ...
    path('q/book-a-meeting/<uuid:user_id>/', views.book_a_meeting_v1, name='book_a_meeting_v1'),
